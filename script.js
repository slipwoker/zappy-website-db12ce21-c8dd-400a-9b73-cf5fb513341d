  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && value === '') {
        ...
        const labelText = label ? label.textContent.replace('*', '').trim() : name || 'This field';
      ...
      const scrollObserver = new IntersectionObserver(function (entries, observer) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            if (delay) {
              setTimeout(function () { revealElement(el); }, parseInt(delay, 10));
            } else {
              revealElement(el);
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'db12ce21-c8dd-400a-9b73-cf5fb513341d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'db12ce21-c8dd-400a-9b73-cf5fb513341d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'db12ce21-c8dd-400a-9b73-cf5fb513341d';
